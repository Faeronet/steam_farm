...
var Templates = map[string]GameTemplate{
	"cs2": {
		...
		LaunchOpts: "-novid -nojoy -low -console -w 1280 -h 720 +fps_max 30 +cl_disablehtmlmotd 1 -nosound -nopreload +r_dynamic 0 +mat_queue_mode 0 +con_enable 1 -condebug +r_player_visibility_mode 1 " +
